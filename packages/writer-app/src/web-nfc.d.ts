...
/** biome-ignore-all lint/correctness/noUnusedVariables: This is a declaration */
/** biome-ignore-all lint/suspicious/noExplicitAny: This is a declaration */
...
declare class NDEFReader extends EventTarget {
	...
	addEventListener<K extends keyof NDEFEventMap>(
		type: K,
		listener: (ev: NDEFEventMap[K]) => void,
